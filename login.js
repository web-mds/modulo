...
loginForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        // Obtener el primer documento (asumimos que el nombre de usuario es único)
        ...
        // Autenticar con Firebase Authentication usando el correo y la contraseña almacenados
...
// Manejar "Olvidó su contraseña" (opcional, puedes mantenerlo o ajustarlo)
...
forgotPasswordLink.addEventListener('click', async (e) => {
    ...
    try {
        ...
        // Enviar correo de restablecimiento usando el correo almacenado
