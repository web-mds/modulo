...
onAuthStateChanged(auth, async (user) => {
    if (!user) {
        console.log('No hay usuario autenticado en script.js, redirigiendo a login.html');
        window.location.href = 'login.html';
        return;
    }

    console.log('Usuario autenticado en script.js:', user.email);
    ...
    try {
        ...
        if (!querySnapshot.empty) {
            ...
            document.querySelector('.user-name').textContent = userData.nombreCompleto || 'Usuario';
        ...
        // Set session timeout after initialization
...
function initializePage() {
    ...
    const subOptions = {
        'Implantes': ['Consumos', 'Pacientes', 'Carpetas', 'Formulario', 'Consignado', 'Histórico', 'Ver Pacientes'],
        ...
        'Prestaciones': ['Códigos', 'Médicos', 'Previsiones', 'Empresas', 'Áreas Clínicas', 'Cts Proveedores', 'Cts Clínicos'],
        'Usuarios': ['Registros']
    };
